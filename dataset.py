...
#             print(rotation_params)
            ...
            if torch.rand(1).item()>0.5:
                ...
                image = image = tf.adjust_brightness(image, 1+scale)
            ...
            if torch.rand(1).item()>0.5:
                ...
                image = image = tf.adjust_contrast(image, 1+scale)
...
#     @classmethod
#     def preprocess(cls, image, mask, is_train):
#         image = transforms.Resize(448)(image)
#         mask = transforms.Resize(448, InterpolationMode.NEAREST)(mask)
#         rn = torch.rand(1).item()        
#         if rn > 0.01 and is_train:  
# #             print('Random transform')
#             rn = torch.rand(1).item()
#             if rn>0.2:
#                 #random rotation
...
#             if rn<0.9:
#                 #Random Crop
#                 crop_params = transforms.RandomCrop.get_params(image, (224, 224))
